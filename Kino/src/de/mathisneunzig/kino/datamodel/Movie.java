...
public class Movie {
	...
	private boolean availableIn4D;
	
	public Movie(String name, double length, double rating, boolean availableIn3D, boolean availableIn4D) {
		super();
		this.name = name;
		this.length = length;
		this.rating = rating;
		this.availableIn3D = availableIn3D;
		this.availableIn4D = availableIn4D;
	}
